...
export default function Login() {
  ...
  return (
    <main className="main-content" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(to bottom, rgba(232, 216, 195, 0.8) 0%, rgba(206, 186, 160, 0.9) 100%), url("https://images.unsplash.com/photo-1587582423116-ec07293f0395?auto=format&fit=crop&q=80") center/cover fixed' }}>
